"""
Django settings for MenteSaludable project.
...
ROOT_URLCONF = 'MenteSaludable.urls'
...
WSGI_APPLICATION = 'MenteSaludable.wsgi.application'
...
LOGIN_REDIRECT_URL = 'main:inicio'
